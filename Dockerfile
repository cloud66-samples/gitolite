# FROM https://github.com/miracle2k/dockerfiles dee6c18bcaf5afbd961be026ad0109a676aaa822
...
RUN cd /home/git/gitolite; su git -c "git checkout v3.6.3";
...
# Adding volume to repositories directory
